...
| [IDEA-056](open/idea-056-ble-services-developer-guide.md) | 📖 docs | BLE services developer guide — authoritative doc for implementing/changing BLE services | Docs-only. Single source-of-truth document for adding/changing BLE services in this project. |
