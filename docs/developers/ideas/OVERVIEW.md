...
| [IDEA-056](open/idea-056-ble-services-developer-guide.md) | 📖 docs | BLE services developer guide — authoritative doc for implementing/changing BLE services | Single source of truth for adding/changing BLE services in this project, ideally surfaced by an implementation-aware skill. |
