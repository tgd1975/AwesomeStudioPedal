...
Both services advertise simultaneously. The Config service does not interfere with keyboard
report delivery — chunked writes are processed in the main loop between HID events.
