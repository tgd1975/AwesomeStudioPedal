...
**Overall:** 🔵 **active** — █████░░░░░ 20/43 (47%) across 8 groups — 17 open · 2 active · 4 paused · 20 closed
...
| [EPIC-022](#epic-022-atomic-commit-and-mandatory-commit-path) | Atomic /commit and mandatory commit path | 🔵 **active** | 2 | 1 | 0 | 3 | █████░░░░░ 50% |
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 5 | 1 | 0 | 7 | █████░░░░░ 54% |
...
graph LR
    ...
    click TASK_325 "active/task-325-implement-precommit-hook-enforcement.md"
...
| 4 | [TASK-325](active/task-325-implement-precommit-hook-enforcement.md) | Implement pre-commit hook enforcement of /commit-only commits | 🔵 **active** | Medium (2-8h) |
...
graph LR
    ...
    click TASK_328 "open/task-328-prevent-parallel-housekeep-execution.md"
...
| ? | [TASK-328](open/task-328-prevent-parallel-housekeep-execution.md) | Prevent parallel execution of housekeep.py (and audit sibling scripts) | ⚪ _open_ | Small (<2h) |
