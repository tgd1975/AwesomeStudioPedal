...
**Overall:** 🔵 **active** — ██████░░░░ 24/43 (56%) across 8 groups — 13 open · 2 active · 4 paused · 24 closed
...
| [EPIC-022](#epic-022-atomic-commit-and-mandatory-commit-path) | Atomic /commit and mandatory commit path | 🟢 closed | 0 | 0 | 0 | 6 | ██████████ 100% |
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 3 | 2 | 0 | 8 | ██████░░░░ 62% |
...
graph LR
    ...
    click TASK_319 "active/task-319-remove-wireviz-precommit-block.md"
...
| ? | [TASK-319](active/task-319-remove-wireviz-precommit-block.md) | Pre-commit hook — remove WireViz regen block and verify no remnants | 🔵 **active** | Small (<2h) |
