...
**Overall:** 🔵 **active** — ████░░░░░░ 13/35 (37%) across 7 groups — 17 open · 1 active · 4 paused · 13 closed
...
| [EPIC-021](#epic-021-epic-suggested-branch-with-soft-enforcement) | Epic-suggested branch with soft enforcement | 🔵 **active** | 2 | 0 | 0 | 1 | ███░░░░░░░ 33% |
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 5 | 1 | 0 | 5 | ████░░░░░░ 45% |
...
```mermaid
graph LR
    TASK_317["TASK-317"]:::open
    TASK_318["TASK-318"]:::open
    TASK_316["TASK-316"]:::closed
    TASK_316 --> TASK_317
    TASK_316 --> TASK_318
    click TASK_317 "open/task-317-ts-epic-new-autofill-branch.md"
    click TASK_318 "open/task-318-ts-task-active-branch-nag.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 2 | [TASK-317](open/task-317-ts-epic-new-autofill-branch.md) | `/ts-epic-new` auto-fills `branch: feature/<epic-slug>` | ⚪ _open_ | Small (<2h) |
| 3 | [TASK-318](open/task-318-ts-task-active-branch-nag.md) | `/ts-task-active` nags when current branch ≠ epic's `branch:` | ⚪ _open_ | Medium (2-8h) |
