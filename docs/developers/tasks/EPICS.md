...
**Overall:** 🔵 **active** — ████░░░░░░ 17/42 (40%) across 8 groups — 20 open · 1 active · 4 paused · 17 closed
...
| [EPIC-022](#epic-022-atomic-commit-and-mandatory-commit-path) | Atomic /commit and mandatory commit path | ⚪ _open_ | 6 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 4 | 1 | 0 | 7 | ██████░░░░ 58% |
...
```mermaid
graph LR
    TASK_322["TASK-322"]:::open
    TASK_323["TASK-323"]:::open
    TASK_324["TASK-324"]:::open
    TASK_325["TASK-325"]:::open
    TASK_326["TASK-326"]:::open
    TASK_327["TASK-327"]:::open
    TASK_322 --> TASK_324
    TASK_322 --> TASK_325
    TASK_323 --> TASK_325
    TASK_325 --> TASK_326
    TASK_325 --> TASK_327
    TASK_322 ~~~ TASK_323
    click TASK_322 "open/task-322-decide-commit-provenance-and-bypass-mechanism.md"
    click TASK_323 "open/task-323-convert-commit-skill-to-pathspec-form.md"
    click TASK_324 "open/task-324-update-claudemd-and-add-commit-policy-page.md"
    click TASK_325 "open/task-325-implement-precommit-hook-enforcement.md"
    click TASK_326 "open/task-326-route-other-commit-skills-through-commit.md"
    click TASK_327 "open/task-327-decide-partial-hunk-policy.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-322](open/task-322-decide-commit-provenance-and-bypass-mechanism.md) | Decide commit-provenance signal and bypass mechanism for /commit | ⚪ _open_ | Small (<2h) |
| 2 | [TASK-323](open/task-323-convert-commit-skill-to-pathspec-form.md) | Convert /commit skill to pathspec form | ⚪ _open_ | Small (<2h) |
| 3 | [TASK-324](open/task-324-update-claudemd-and-add-commit-policy-page.md) | Update CLAUDE.md and add COMMIT_POLICY.md rationale page | ⚪ _open_ | Small (<2h) |
| 4 | [TASK-325](open/task-325-implement-precommit-hook-enforcement.md) | Implement pre-commit hook enforcement of /commit-only commits | ⚪ _open_ | Medium (2-8h) |
| 5 | [TASK-326](open/task-326-route-other-commit-skills-through-commit.md) | Route /release, /release-branch, and other commit-issuing skills through /commit | ⚪ _open_ | Medium (2-8h) |
| 6 | [TASK-327](open/task-327-decide-partial-hunk-policy.md) | Decide partial-hunk policy — unsupported, or /commit --partial escape hatch | ⚪ _open_ | Small (<2h) |

## Unassigned

[↑ back to top](#index)

**Status:** 🔵 **active** — ██████░░░░ 7/12 (58%)
...
graph LR
    ...
    TASK_147 --> TASK_148
    TASK_259 ~~~ TASK_260 ~~~ TASK_303 ~~~ TASK_304 ~~~ TASK_305 ~~~ TASK_313 ~~~ TASK_314 ~~~ TASK_315 ~~~ TASK_319 ~~~ TASK_320 ~~~ TASK_321
    ...
    click TASK_321 "active/task-321-fix-ci-failures-mermaid-clang-tidy.md"
...
| ? | [TASK-321](active/task-321-fix-ci-failures-mermaid-clang-tidy.md) | Fix CI failures (Mermaid lint, clang-tidy) and prevent dirty pushes | 🔵 **active** | Medium (2-8h) |
