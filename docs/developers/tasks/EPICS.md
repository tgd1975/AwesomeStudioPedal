...
graph LR
    ...
    click TASK_320 "active/task-320-remove-ble-flag-precommit-check.md"
...
| ? | [TASK-320](active/task-320-remove-ble-flag-precommit-check.md) | Pre-commit hook — remove BLE_CONFIG_TEST_BUILD check (orphan from TASK-236) | 🔵 **active** | XS (<30m) |
