...
**Overall:** 🔵 **active** — ███████░░░ 54/79 (68%) across 12 groups — 18 open · 0 active · 7 paused · 54 closed

## Index

| Epic | Title | Status | Open | Active | Paused | Closed | Done |
|------|-------|--------|-----:|-------:|-------:|-------:|------|
| [EPIC-012](#epic-012-app-store-distribution) | App store distribution | 🔵 **active** | 2 | 0 | 0 | 1 | ███░░░░░░░ 33% |
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 5 | 0 | 0 | 16 | ████████░░ 76% |
...
| 3 | [TASK-364](open/task-364-thin-out-release-skill.md) | Thin out /release skill — drop firmware build and gh release create, let CI handle release artifacts | ⚪ _open_ | Small (&lt;2h) |
...
**Status:** 🔵 **active** — ████████░░ 16/21 (76%)

```mermaid
graph LR
    TASK_148["TASK-148"]:::open
    TASK_352["TASK-352"]:::open
    TASK_361["TASK-361"]:::open
    TASK_362["TASK-362"]:::open
    TASK_363["TASK-363"]:::open
    ...
    TASK_147 --> TASK_148
    TASK_260 --> TASK_350
    TASK_259 ~~~ TASK_260 ~~~ TASK_303 ~~~ TASK_304 ~~~ TASK_305 ~~~ TASK_313 ~~~ TASK_314 ~~~ TASK_315 ~~~ TASK_319 ~~~ TASK_320 ~~~ TASK_321 ~~~ TASK_328 ~~~ TASK_346 ~~~ TASK_348 ~~~ TASK_351 ~~~ TASK_352 ~~~ TASK_361 ~~~ TASK_362 ~~~ TASK_363
    ...
    click TASK_361 "open/task-361-lint-platformio-ini-pre-commit-and-ci.md"
    click TASK_362 "open/task-362-require-ci-pass-before-merge-to-main.md"
    click TASK_363 "open/task-363-investigate-recurring-ci-failures.md"
...
| ? | [TASK-361](open/task-361-lint-platformio-ini-pre-commit-and-ci.md) | Lint platformio.ini in pre-commit and CI | ⚪ _open_ | Small (&lt;2h) |
| ? | [TASK-362](open/task-362-require-ci-pass-before-merge-to-main.md) | Require all CI checks to pass before merging to main | ⚪ _open_ | Medium (2-8h) |
| ? | [TASK-363](open/task-363-investigate-recurring-ci-failures.md) | Investigate why CI still fails after TASK-321 — fix or scaffold follow-up | ⚪ _open_ | Small (&lt;2h) |
