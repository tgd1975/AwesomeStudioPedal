...
**Overall:** 🔵 **active** — █████░░░░░ 30/63 (48%) across 10 groups — 28 open · 1 active · 4 paused · 30 closed
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 2 | 1 | 0 | 12 | ████████░░ 80% |
...
graph LR
    ...
    click TASK_348 "active/task-348-derive-clang-tidy-set-from-compile-commands.md"
...
| ? | [TASK-348](active/task-348-derive-clang-tidy-set-from-compile-commands.md) | Derive clang-tidy lint set from compile_commands.json | 🔵 **active** | Small (<2h) |
