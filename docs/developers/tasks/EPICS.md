...
**Overall:** 🔵 **active** — ███████░░░ 49/73 (67%) across 10 groups — 19 open · 1 active · 4 paused · 49 closed
...
| [EPIC-023](#epic-023-app-content-pages-and-connection-visibility) | App content pages and connection visibility | 🔵 **active** | 5 | 0 | 0 | 11 | ███████░░░ 69% |
| [EPIC-024](#epic-024-logo-and-branding-consistency-across-apps-and-tools) | Logo and branding consistency across apps and tools | 🔵 **active** | 2 | 1 | 0 | 4 | ██████░░░░ 57% |
...
| 16 | [TASK-358](open/task-358-nrf52840-ble-readback-surfaces.md) | nRF52840 BLE readback surfaces (firmware-version DIS + config readback + active-profile notify) | ⚪ _open_ | Large (8-24h) |
...
graph LR
    ...
    click TASK_345 "active/task-345-swap-android-launcher-icon-to-asp-mark.md"
...
| 7 | [TASK-345](active/task-345-swap-android-launcher-icon-to-asp-mark.md) | Swap Android launcher icon to ASP mark | 🔵 **active** | Medium (2-8h) |
