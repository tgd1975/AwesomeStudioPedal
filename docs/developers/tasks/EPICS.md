...
**Overall:** 🔵 **active** — ████░░░░░░ 16/36 (44%) across 7 groups — 15 open · 1 active · 4 paused · 16 closed
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 5 | 1 | 0 | 6 | █████░░░░░ 50% |
...
graph LR
    ...
    click TASK_321 "open/task-321-fix-ci-failures-mermaid-clang-tidy.md"
...
| ? | [TASK-321](open/task-321-fix-ci-failures-mermaid-clang-tidy.md) | Fix CI failures (Mermaid lint, clang-tidy) and prevent dirty pushes | ⚪ _open_ | Medium (2-8h) |
