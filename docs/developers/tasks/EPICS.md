...
**Overall:** 🔵 **active** — █████░░░░░ 29/62 (47%) across 10 groups — 29 open · 0 active · 4 paused · 29 closed
...
| [EPIC-022](#epic-022-atomic-commit-and-mandatory-commit-path) | Atomic /commit and mandatory commit path | 🔵 **active** | 1 | 0 | 0 | 7 | █████████░ 88% |
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 2 | 0 | 0 | 12 | █████████░ 86% |
...
graph TD
    ...
    click TASK_347 "open/task-347-fix-commit-rename-and-deletion-handling.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 8 | [TASK-347](open/task-347-fix-commit-rename-and-deletion-handling.md) | Fix /commit + commit-pathspec.sh to handle deletions and renames (orphan-deletion bug) | ⚪ _open_ | Small (<2h) |
...
graph LR
    ...
    TASK_147 --> TASK_148
    TASK_259 ~~~ TASK_260 ~~~ TASK_303 ~~~ TASK_304 ~~~ TASK_305 ~~~ TASK_313 ~~~ TASK_314 ~~~ TASK_315 ~~~ TASK_319 ~~~ TASK_320 ~~~ TASK_321 ~~~ TASK_328 ~~~ TASK_346
