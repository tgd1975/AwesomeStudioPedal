...
**Overall:** 🔵 **active** — ██████░░░░ 26/44 (59%) across 8 groups — 13 open · 1 active · 4 paused · 26 closed
...
| [EPIC-022](#epic-022-atomic-commit-and-mandatory-commit-path) | Atomic /commit and mandatory commit path | 🔵 **active** | 1 | 0 | 0 | 6 | █████████░ 86% |
...
graph TD
    ...
    click TASK_329 "open/task-329-drop-auto-git-add-from-commit-pathspec.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 7 | [TASK-329](open/task-329-drop-auto-git-add-from-commit-pathspec.md) | Drop auto-git-add for untracked files from commit-pathspec.sh | ⚪ _open_ | Small (<2h) |
