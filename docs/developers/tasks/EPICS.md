...
**Overall:** 🔵 **active** — █████░░░░░ 28/61 (46%) across 10 groups — 29 open · 0 active · 4 paused · 28 closed
...
| [EPIC-022](#epic-022-atomic-commit-and-mandatory-commit-path) | Atomic /commit and mandatory commit path | 🟢 closed | 0 | 0 | 0 | 7 | ██████████ 100% |
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 3 | 0 | 0 | 11 | ████████░░ 79% |
...
**Status:** 🔵 **active** — ████████░░ 11/14 (79%)

```mermaid
graph LR
    TASK_148["TASK-148"]:::open
    TASK_260["TASK-260"]:::open
    TASK_346["TASK-346"]:::open
    ...
    click TASK_346 "open/task-346-content-sensitive-precommit-checks.md"
...
| ? | [TASK-346](open/task-346-content-sensitive-precommit-checks.md) | Make pre-commit C++ and app checks content-sensitive | ⚪ _open_ | Small (<2h) |
