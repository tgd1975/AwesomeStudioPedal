...
**Overall:** 🔵 **active** — █████░░░░░ 33/66 (50%) across 10 groups — 28 open · 1 active · 4 paused · 33 closed
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 1 | 1 | 0 | 15 | █████████░ 88% |
...
**Status:** 🔵 **active** — █████████░ 15/17 (88%)

```mermaid
graph LR
    TASK_148["TASK-148"]:::open
    TASK_350["TASK-350"]:::active
    ...
    click TASK_350 "active/task-350-display-unified-version-in-web-tooling.md"
...
| ? | [TASK-350](active/task-350-display-unified-version-in-web-tooling.md) | Display unified version in web tooling (simulator + builders) | 🔵 **active** | Small (&lt;2h) |
