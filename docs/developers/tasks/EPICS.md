...
**Overall:** 🔵 **active** — ███████░░░ 47/71 (66%) across 10 groups — 19 open · 1 active · 4 paused · 47 closed
...
| [EPIC-024](#epic-024-logo-and-branding-consistency-across-apps-and-tools) | Logo and branding consistency across apps and tools | 🔵 **active** | 4 | 1 | 0 | 2 | ███░░░░░░░ 29% |
...
graph LR
    ...
    click TASK_341 "active/task-341-add-asp-logo-to-configuration-builder-header.md"
...
| 3 | [TASK-341](active/task-341-add-asp-logo-to-configuration-builder-header.md) | Add ASP logo to configuration builder header | 🔵 **active** | Small (&lt;2h) |
