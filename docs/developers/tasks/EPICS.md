...
**Overall:** 🔵 **active** — ███░░░░░░░ 10/33 (30%) across 7 groups — 18 open · 1 active · 4 paused · 10 closed
...
| [EPIC-020](#epic-020-config-driven-runtime-customisation) | Config-driven runtime customisation | 🔵 **active** | 0 | 1 | 0 | 6 | █████████░ 86% |
...
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 5 | 0 | 0 | 4 | ████░░░░░░ 44% |
...
graph TD
    ...
    TASK_310 --> TASK_312
    TASK_306 ~~~ TASK_310
    click TASK_309 "active/task-309-profile-independent-actions-flutter-app.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 4 | [TASK-309](active/task-309-profile-independent-actions-flutter-app.md) | Profile-independent actions — Flutter app support | 🔵 **active** | Small (<2h) |
...
graph LR
    ...
    TASK_147 --> TASK_148
    TASK_259 ~~~ TASK_260 ~~~ TASK_303 ~~~ TASK_304 ~~~ TASK_305 ~~~ TASK_313 ~~~ TASK_314 ~~~ TASK_315
