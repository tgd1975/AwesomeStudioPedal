...
**Overall:** 🔵 **active** — ███░░░░░░░ 9/33 (27%) across 7 groups — 19 open · 1 active · 4 paused · 9 closed
...
| [EPIC-020](#epic-020-config-driven-runtime-customisation) | Config-driven runtime customisation | 🔵 **active** | 1 | 1 | 0 | 5 | ███████░░░ 71% |
...
graph TD
    ...
    click TASK_308 "active/task-308-profile-independent-actions-config-builder.md"
...
| 3 | [TASK-308](active/task-308-profile-independent-actions-config-builder.md) | Profile-independent actions — web config builder support | 🔵 **active** | Small (<2h) |
