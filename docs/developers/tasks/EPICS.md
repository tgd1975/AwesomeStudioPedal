...
**Overall:** 🔵 **active** — █████░░░░░ 31/66 (47%) across 10 groups — 31 open · 0 active · 4 paused · 31 closed
...
| [EPIC-023](#epic-023-app-content-pages-and-connection-visibility) | App content pages and connection visibility | ⚪ _open_ | 10 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
| [EPIC-024](#epic-024-logo-and-branding-consistency-across-apps-and-tools) | Logo and branding consistency across apps and tools | ⚪ _open_ | 7 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 4 | 0 | 0 | 13 | ████████░░ 76% |
...
```mermaid
graph LR
    TASK_330["TASK-330"]:::open
    TASK_331["TASK-331"]:::open
    TASK_332["TASK-332"]:::open
    TASK_333["TASK-333"]:::open
    TASK_334["TASK-334"]:::open
    TASK_335["TASK-335"]:::open
    TASK_336["TASK-336"]:::open
    TASK_337["TASK-337"]:::open
    TASK_338["TASK-338"]:::open
    TASK_349["TASK-349"]:::open
    TASK_260["TASK-260"]:::openExt
    TASK_330 --> TASK_331
    TASK_331 --> TASK_332
    TASK_331 --> TASK_333
    TASK_337 --> TASK_338
    TASK_260 --> TASK_349
    TASK_330 ~~~ TASK_334 ~~~ TASK_335 ~~~ TASK_336 ~~~ TASK_337
    click TASK_330 "open/task-330-decide-content-page-open-questions.md"
    click TASK_331 "open/task-331-add-info-about-page.md"
    click TASK_332 "open/task-332-add-howto-quickstart-page.md"
    click TASK_333 "open/task-333-add-profiles-troubleshooting-legal-pages.md"
    click TASK_334 "open/task-334-add-startup-splash-screen.md"
    click TASK_335 "open/task-335-add-connection-status-strip-and-details-sheet.md"
    click TASK_336 "open/task-336-add-connected-pedal-page-board-only.md"
    click TASK_337 "open/task-337-firmware-expose-version-config-active-profile.md"
    click TASK_338 "open/task-338-add-hid-display-table-and-live-keystroke-page.md"
    click TASK_349 "open/task-349-display-unified-version-in-mobile-app.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-330](open/task-330-decide-content-page-open-questions.md) | Decide content-page open questions (source-of-truth, i18n, context-awareness, first-run) | ⚪ _open_ | Small (<2h) |
| 2 | [TASK-331](open/task-331-add-info-about-page.md) | Add Info/About page to the Flutter app | ⚪ _open_ | Medium (2-8h) |
| 3 | [TASK-332](open/task-332-add-howto-quickstart-page.md) | Add How-To quickstart page (3–5 steps) | ⚪ _open_ | Small (<2h) |
| 4 | [TASK-333](open/task-333-add-profiles-troubleshooting-legal-pages.md) | Add Profiles explainer, Troubleshooting, and Legal pages | ⚪ _open_ | Medium (2-8h) |
| 5 | [TASK-334](open/task-334-add-startup-splash-screen.md) | Add startup splash screen (Flutter + native) | ⚪ _open_ | Medium (2-8h) |
| 6 | [TASK-335](open/task-335-add-connection-status-strip-and-details-sheet.md) | Add connection status strip and details sheet | ⚪ _open_ | Medium (2-8h) |
| 7 | [TASK-336](open/task-336-add-connected-pedal-page-board-only.md) | Add Connected-Pedal page (board only; firmware/config sections placeholdered) | ⚪ _open_ | Medium (2-8h) |
| 8 | [TASK-337](open/task-337-firmware-expose-version-config-active-profile.md) | Firmware — expose firmware version, readable config, active-profile notify (BLE) | ⚪ _open_ | Large (8-24h) |
| 9 | [TASK-338](open/task-338-add-hid-display-table-and-live-keystroke-page.md) | Add HID-usage display lookup table (generated) and Live-keystroke page | ⚪ _open_ | Large (8-24h) |
| 10 | [TASK-349](open/task-349-display-unified-version-in-mobile-app.md) | Display unified version in mobile app | ⚪ _open_ | Small (<2h) |
...
```mermaid
graph LR
    TASK_339["TASK-339"]:::open
    TASK_340["TASK-340"]:::open
    TASK_341["TASK-341"]:::open
    TASK_342["TASK-342"]:::open
    ...
    click TASK_339 "open/task-339-add-asp-logo-to-web-simulator-header.md"
    click TASK_340 "open/task-340-add-asp-logo-to-profile-builder-header.md"
    click TASK_341 "open/task-341-add-asp-logo-to-configuration-builder-header.md"
    click TASK_342 "open/task-342-add-asp-logo-to-mobile-app-appbar.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-339](open/task-339-add-asp-logo-to-web-simulator-header.md) | Add ASP logo to web simulator header | ⚪ _open_ | Small (<2h) |
| 2 | [TASK-340](open/task-340-add-asp-logo-to-profile-builder-header.md) | Add ASP logo to profile builder header | ⚪ _open_ | Small (<2h) |
| 3 | [TASK-341](open/task-341-add-asp-logo-to-configuration-builder-header.md) | Add ASP logo to configuration builder header | ⚪ _open_ | Small (<2h) |
| 4 | [TASK-342](open/task-342-add-asp-logo-to-mobile-app-appbar.md) | Add ASP logo to mobile app AppBar | ⚪ _open_ | Small (<2h) |
...
**Status:** 🔵 **active** — ████████░░ 13/17 (76%)

```mermaid
graph LR
    TASK_148["TASK-148"]:::open
    TASK_260["TASK-260"]:::open
    TASK_350["TASK-350"]:::open
    TASK_351["TASK-351"]:::open
    ...
    TASK_147 --> TASK_148
    TASK_260 --> TASK_350
    TASK_259 ~~~ TASK_260 ~~~ TASK_303 ~~~ TASK_304 ~~~ TASK_305 ~~~ TASK_313 ~~~ TASK_314 ~~~ TASK_315 ~~~ TASK_319 ~~~ TASK_320 ~~~ TASK_321 ~~~ TASK_328 ~~~ TASK_346 ~~~ TASK_348 ~~~ TASK_351
    click TASK_148 "open/task-148-reorganise-developer-documentation.md"
    click TASK_260 "open/task-260-unify-version-numbers-across-deliverables.md"
    click TASK_350 "open/task-350-display-unified-version-in-web-tooling.md"
    click TASK_351 "open/task-351-ensure-autogenerated-markdown-is-lint-clean.md"
...
| ? | [TASK-350](open/task-350-display-unified-version-in-web-tooling.md) | Display unified version in web tooling (simulator + builders) | ⚪ _open_ | Small (<2h) |
| ? | [TASK-351](open/task-351-ensure-autogenerated-markdown-is-lint-clean.md) | Ensure all autogenerated markdown is markdownlint-clean | ⚪ _open_ | Medium (2-8h) |
