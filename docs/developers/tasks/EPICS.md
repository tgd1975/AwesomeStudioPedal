...
**Overall:** 🔵 **active** — █████░░░░░ 29/63 (46%) across 10 groups — 29 open · 1 active · 4 paused · 29 closed
...
| [EPIC-022](#epic-022-atomic-commit-and-mandatory-commit-path) | Atomic /commit and mandatory commit path | 🔵 **active** | 0 | 1 | 0 | 7 | █████████░ 88% |
| [EPIC-023](#epic-023-app-content-pages-and-connection-visibility) | App content pages and connection visibility | ⚪ _open_ | 9 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
| [LogoBranding](#logobranding-logobranding) | LogoBranding | ⚪ _open_ | 7 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
graph TD
    ...
    click TASK_347 "active/task-347-fix-commit-rename-and-deletion-handling.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 8 | [TASK-347](active/task-347-fix-commit-rename-and-deletion-handling.md) | Fix /commit + commit-pathspec.sh to handle deletions and renames (orphan-deletion bug) | 🔵 **active** | Small (<2h) |
...
graph LR
    ...
    TASK_147 --> TASK_148
    TASK_259 ~~~ TASK_260 ~~~ TASK_303 ~~~ TASK_304 ~~~ TASK_305 ~~~ TASK_313 ~~~ TASK_314 ~~~ TASK_315 ~~~ TASK_319 ~~~ TASK_320 ~~~ TASK_321 ~~~ TASK_328 ~~~ TASK_346 ~~~ TASK_348
    ...
    click TASK_348 "open/task-348-derive-clang-tidy-set-from-compile-commands.md"
...
| ? | [TASK-348](open/task-348-derive-clang-tidy-set-from-compile-commands.md) | Derive clang-tidy lint set from compile_commands.json | ⚪ _open_ | Small (<2h) |
