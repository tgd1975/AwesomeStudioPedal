...
**Epics:** [app-content-pages](#app-content-pages) · [commit-atomicity](#commit-atomicity) · [distribution](#distribution) · [feature_test](#feature_test) · [iphone-app](#iphone-app) · [LogoBranding](#logobranding) · [video-content](#video-content) · [Other](#other)
...
kanban
  ...
  Closed
    ...
    TASK_323["Convert /commit skill to pathspec form"]
    TASK_324["Update CLAUDE.md and add COMMIT_POLICY.md rationale page"]
    TASK_325["Implement pre-commit hook enforcement of /commit-only commits"]
    TASK_326["Route /release, /release-branch, and other commit-issuing skills through /commit"]
    TASK_327["Decide partial-hunk policy — unsupported, or /commit --partial escape hatch"]
    TASK_329["Drop auto-git-add for untracked files from commit-pathspec.sh"]
```
