...
**Epics:** [app-content-pages](#app-content-pages) · [distribution](#distribution) · [feature_test](#feature_test) · [iphone-app](#iphone-app) · [logo-branding](#logo-branding) · [nrf52840-blocked](#nrf52840-blocked) · [video-content](#video-content) · [Other](#other)

## app-content-pages

_⚪ 4 open · 🔵 0 active · 🟡 0 paused · 🟢 11 closed · ███████░░░ 73%_
...
kanban
  Open
    ...
    TASK_357["Reconcile MAX_CONFIG_BYTES between BLE protocol doc and reassembler code"]
  Active
  Paused
  Closed
    ...
    TASK_337["Firmware — expose firmware version, readable config, active-profile notify (BLE) [SPLIT]"]
    ...
    TASK_353["Feasibility & impact analysis — firmware BLE readback surfaces"]
```
...
_⚪ 1 open · 🔵 1 active · 🟡 0 paused · 🟢 5 closed · ███████░░░ 71%_
