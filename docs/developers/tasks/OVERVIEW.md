...
|----|-------|--------|------------|--------|
| [TASK-354](active/task-354-firmware-version-read-characteristic.md) | Firmware — expose firmware-version read characteristic (+ DIS 0x180A decision) | Small (&lt;2h) | Medium | 🔵 **active** |
