...
⚪ **Open: 19** | 🔵 **Active: 1** | 🟡 **Paused: 4** | 🟢 **Closed: 9** | **Total: 33** | ███░░░░░░░ 27%
...
|----|-------|--------|------------|--------|
| [TASK-308](active/task-308-profile-independent-actions-config-builder.md) | Profile-independent actions — web config builder support | Small (<2h) | Medium | 🔵 **active** |
