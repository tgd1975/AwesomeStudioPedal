...
⚪ **Open: 19** | 🔵 **Active: 1** | 🟡 **Paused: 4** | 🟢 **Closed: 48** | **Total: 72** | ███████░░░ 67%
...
|----|-------|--------|------------|--------|
| [TASK-342](active/task-342-add-asp-logo-to-mobile-app-appbar.md) | Add ASP logo to mobile app AppBar | Small (&lt;2h) | Junior | 🔵 **active** |
