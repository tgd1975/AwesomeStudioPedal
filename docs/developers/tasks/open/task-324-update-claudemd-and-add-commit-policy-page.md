...
- [ ] CLAUDE.md states the `/commit`-only rule with a link to
      `docs/developers/COMMIT_POLICY.md` for rationale.
- [ ] `docs/developers/COMMIT_POLICY.md` exists, explains the race that
...
- [ ] `/doc-check` passes on the new file (developer persona).
