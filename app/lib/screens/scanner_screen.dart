    ...
    if (_error != null) {
      ...
      if (isBtOff) {
        return _ErrorCard(
          ...
          message: 'Enable Bluetooth in your device settings to scan for the pedal.',
      ...
      if (isPermission) {
        return _ErrorCard(
          ...
          message: 'Allow Bluetooth access for this app in your device permissions.',
          actionLabel: 'Open App Settings',
          onAction: () {
            // AppSettings.openAppSettings() would require app_settings package.
            // Show dialog with instructions instead.
            showDialog<void>(
              context: context,
              builder: (_) => const AlertDialog(
                title: Text('Open App Settings'),
                content: Text(
                  'Go to Settings → Apps → AwesomeStudioPedal → Permissions → Bluetooth → Allow.',
                ),
              ),
            );
          },
