...
void main() {
  group('ActionConfig round-trip', () {
    test('SendKeyAction', () {
      final a = ActionConfig(type: 'SendKeyAction', value: 'KEY_F5', name: 'F5');
      expect(ActionConfig.fromJson(a.toJson()).toJson(), equals(a.toJson()));
    });

    test('SendMediaKeyAction', () {
      final a = ActionConfig(type: 'SendMediaKeyAction', value: 'MEDIA_PLAY_PAUSE');
      expect(ActionConfig.fromJson(a.toJson()).toJson(), equals(a.toJson()));
    });
    ...
    test('DelayedAction with nested action', () {
      ...
      final a = ActionConfig(type: 'DelayedAction', delayMs: 200, action: nested);
